...
html_title = "Sphinx xyzstyle Theme Demo"
html_copy_source = True
html_favicon = "_static/images/favicon.jpg"
html_last_updated_fmt = '%Y-%m-%d, %H:%M:%S'

# Define the json_url for our version switcher.
json_url = "https://xbook.readthedocs.io/zh-cn/latest/_static/switcher.json"
...
blog_baseurl = "https://xbook.readthedocs.io/zh-cn/latest/"
